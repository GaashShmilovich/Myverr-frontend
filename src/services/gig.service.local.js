...
// 						country: {name:"Thailand", img: 'https://fiverr-dev-res.cloudinary.com/general_assets/flags/1f1f9-1f1ed.png' },
// 				},
// 			},
// 				{
// 					id: utilService.makeId(),
...
// 			],
// 			packages: [
// 				{level: 'Basic' ,price: 172, title: 'The Gold Fish - Basic', specials: ['Product imagery', '1 length variation', '20 seconds running time'], benefit1: '5 Day Delivery', benefit2: '2 Revisions', description: 'Start-up and basic logos included. Good for Socialmedia & small business owners (ex: Nike logo)' },
// 				{level: 'Standard' ,price: 280, title: 'The Dolphin - Recommended', specials: ['Voice over recording', 'Product imagery writing', '20 seconds running time'], benefit1: '2 Day Delivery', benefit2:'4 Revisions', description: 'Mid-Segment variants of logo. Highlyrecommended for pro business and printing (ex: AirBnb) ' },
// 				{level: 'Premium', price: 320, title: 'The Blue Whale - Premium', specials: ['Video editing', 'Script writing', '20 seconds running time'], benefit1: '1 Day Delivery' ,benefit2: '5 Revisions', description: 'Ultimate and deep conceptual logo design. Must for premiumbusiness & high-end users (ex: Mercedes)' }
// 			],
// 		}),
// 		await storageService.post(STORAGE_KEY, {
// 			_id: 'i105',
...
// 						country: {name:'USA', img: 'https://fiverr-dev-res.cloudinary.com/general_assets/flags/1f1fa-1f1f8.png'}
// 					},
// 				},
// 			],
// 			packages: [
// 				{level: 'Basic' ,price: 50, title: 'The Gold Fish - Basic', specials: ['Product imagery', '1 length variation', '20 seconds running time'], benefit1: '5 Day Delivery', benefit2: '2 Revisions', description: 'Start-up and basic logos included. Good for Socialmedia & small business owners (ex: Nike logo)' },
// 				{level: 'Standard' ,price: 80, title: 'The Dolphin - Recommended', specials: ['Voice over recording', 'Product imagery writing', '20 seconds running time'], benefit1: '2 Day Delivery', benefit2:'4 Revisions', description: 'Mid-Segment variants of logo. Highlyrecommended for pro business and printing (ex: AirBnb) ' },
// 				{level: 'Premium', price: 120, title: 'The Blue Whale - Premium', specials: ['Video editing', 'Script writing', '20 seconds running time'], benefit1: '1 Day Delivery' ,benefit2: '5 Revisions', description: 'Ultimate and deep conceptual logo design. Must for premiumbusiness & high-end users (ex: Mercedes)' }
// 			],
// 		})
...
// 			],
// 			packages: [
// 				{level: 'Basic' ,price: 70, title: 'The Gold Fish - Basic', specials: ['Product imagery', '1 length variation', '20 seconds running time'], benefit1: '5 Day Delivery', benefit2: '2 Revisions', description: 'Start-up and basic logos included. Good for Socialmedia & small business owners (ex: Nike logo)' },
// 				{level: 'Standard' ,price: 120, title: 'The Dolphin - Recommended', specials: ['Voice over recording', 'Product imagery writing', '20 seconds running time'], benefit1: '2 Day Delivery', benefit2:'4 Revisions', description: 'Mid-Segment variants of logo. Highlyrecommended for pro business and printing (ex: AirBnb) ' },
// 				{level: 'Premium', price: 160, title: 'The Blue Whale - Premium', specials: ['Video editing', 'Script writing', '20 seconds running time'], benefit1: '1 Day Delivery' ,benefit2: '5 Revisions', description: 'Ultimate and deep conceptual logo design. Must for premiumbusiness & high-end users (ex: Mercedes)' }
// 			],
// 		})
// 		await storageService.post(STORAGE_KEY, {
// 			_id: 'i108',
...
// 				  imgUrl: 'https://fiverr-res.cloudinary.com/image/upload/f_auto,q_auto,t_profile_small/v1/profile/photos/112233/original/photo.jpg',
// 				  level: 'pro',
// 				  rate: 5,
...
// 				},
// 				daysToMake: 7,
// 				description: 'Welcome to my website design gig! I specialize in creating modern and responsive websites that cater to your specific needs. Whether you need a personal portfolio, an e-commerce site, or a corporate website, I\'ll ensure that your design aligns with your brand identity and effectively communicates your message. With attention to user experience and SEO best practices, your website will be ready to attract and engage your target audience. Let\'s work together to bring your vision to life!',
// 				imgUrls: [
// 				  'https://fiverr-res.cloudinary.com/image/upload/t_gig_pdf_gallery_view_ver4,f_jpg/20230613/modern%20logo_dayorn.jpg',
// 				  'https://fiverr-res.cloudinary.com/images/t_main1,q_auto,f_auto,q_auto,f_auto/gigs2/115533372/original/7f5fb73fed2347bc06b0a98f5d49c311dbac86ac/do-modern-minimalist-logo-design-for-your-business.jpg',
// 				],
...
// 				  },
// 				  {
// 					question: 'What if I need revisions after the website is complete?',
...
// 				],
// 				packages: [
// 				  { level: 'Basic', price: 300, title: 'Starter Package', specials: ['3-page design', 'Responsive layout', 'Contact form'], benefit1: '7 Day Delivery', benefit2: '3 Revisions', description: 'Perfect for small businesses and startups looking to establish an online presence.' },
// 				  { level: 'Standard', price: 500, title: 'Standard Package', specials: ['5-page design', 'SEO optimization', 'Customizable elements'], benefit1: '5 Day Delivery', benefit2: '5 Revisions', description: 'Ideal for growing businesses that require a more comprehensive website with additional features.' },
// 				  { level: 'Premium', price: 800, title: 'Premium Package', specials: ['10-page design', 'E-commerce integration', 'Custom animations'], benefit1: '3 Day Delivery', benefit2: 'Unlimited Revisions', description: 'For established businesses looking for a top-notch website with advanced functionalities and a unique user experience.' },
// 				],
// 			  })
