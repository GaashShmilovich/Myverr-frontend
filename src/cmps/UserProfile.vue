<template>
	...
	<div class="chat-button-container" @click="showChatRoom = !showChatRoom">
		<div class="avatar">
			<img :src="findUserOnOtherSide.imgUrl" alt="" />
		</div>
		<div class="content">
	...
	<section class="chat-room">
		<ChatRoom
			v-if="showChatRoom"
			:userOnOtherSide="findUserOnOtherSide"
			:msgHistory="gig?.msgs || []"
	...
	computed: {
		findUserOnOtherSide() {
			if (this.loggedinUser.isSeller) {
				...
				return {
					_id: '64cd02e1856dea9794a616a4',
					fullname: 'Oryan',
					imgUrl: 'https://res.cloudinary.com/djm30uwim/image/upload/v1691300650/T04U05NLZ2M-U055TJHS215-337363a46142-512_g7aibi.jpg',
				}
			} else {
				// console.log(this.loggedinUser);
				...
				return {
					_id: '64cd35578f0ee9ee8c823586',
					fullname: 'Gaash Shmilovich',
					imgUrl: 'https://res.cloudinary.com/djm30uwim/image/upload/v1691300560/T04U05NLZ2M-U0511SL2JAE-5a79c2b1c487-512_nu9lgh.png',
					isSeller: true,
				}
			}
		},
