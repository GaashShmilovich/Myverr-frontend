	...
	<section class="dashboard-container">
		<div class="user-profile">
			<div class="user-info">
				...
				<div class="country">
					<span
						><i class="search" v-html="$getSvg('place')"> </i>
						Country</span
					>
					{{ user.country }}
				</div>
			...
			<div class="user-description">
				...
				<div class="desc-content">
					<p>
						Hi there! I'm a creative graphic designer with a passion
						for bringing ideas to life. I specialize in logo design,
						branding, and social media graphics. Let's work together
